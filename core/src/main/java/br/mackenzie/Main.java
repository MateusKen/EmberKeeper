...
//
//        Actor heatActor = new ShapeActor(shape, sr -> heatMeter.draw(sr, viewport));
//        Actor leftAnimActor = new ActorAdapter((b, a) -> {
//            // se sua animação usa SpriteBatch:
//            // leftAnimation.render(b, viewport);
//        });
//        Actor rightAnimActor = new ActorAdapter((b, a) -> {
//            // rightAnimation.render(b, viewport);
//        });
//        Actor rhythmActor = new ShapeActor(shape, sr -> rhythmBar.draw(sr, viewport));
//
//        GameLayoutScreen screen = new GameLayoutScreen(heatActor, leftAnimActor, rightAnimActor, rhythmActor);
//        setScreen(screen);
//    }
//
//    @Override
...
//
//        super.render(); // delega para o GameLayoutScreen (stage.act/draw)
//    }
//
//    private void draw() {
...
package br.mackenzie;
import br.mackenzie.layout.LayoutScreen;
import com.badlogic.gdx.Game;

// Esta é sua classe "main" que está no 'DesktopLauncher' ou 'AndroidLauncher'
public class Main extends Game {

    @Override
    public void create() {
        // A única responsabilidade da classe Game é
        // carregar assets globais (se houver) e definir a primeira tela.

        // Inicia a Tela de Layout
        setScreen(new LayoutScreen());
    }
}
